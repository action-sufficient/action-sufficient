...
class CubeEnv(ManipSpaceEnv):
    ...
    def __init__(self, env_type, permute_blocks=True, *args, **kwargs):
        ...
        # Random initialization of cube positions.
        self._random_init_cube = True
    ...
    def initialize_episode(self):
        ...
        if self._mode == 'data_collection':
            ...
            for i in range(self._num_cubes):
                ...
                # if self._random_init_cube == False, use fixed initial cube positions. (arm position is still randomized.)
                if self._random_init_cube == False:
    ...
    def reset(self, options=None, *args, **kwargs):
        if self._mode == 'task':
            ...
            # Whether to random initialize cube state.
            self._random_init_cube = True
            if 'random_init_cube' in options:
                self._random_init_cube = options['random_init_cube']
